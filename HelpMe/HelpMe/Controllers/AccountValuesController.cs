...
using HelpMe.Providers;
using HelpMe.Results;

namespace HelpMe.Controllers
{
        [Authorize]
        [RoutePrefix("api/AccountValues")]
        public class AccountValuesController : ApiController
        {
            private const string LocalLoginProvider = "Local";
            private ApplicationUserManager _userManager;

            public AccountValuesController()
            {
            }

            public AccountValuesController(ApplicationUserManager userManager,
