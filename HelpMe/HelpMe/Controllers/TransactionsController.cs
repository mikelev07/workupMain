...
namespace HelpMe.Controllers
{
    public class TransactionsController : Controller
    {
        ...
        {
            return View(db.Transactions.Include(i => i.FromUser).Include(i => i.ToUser).ToList());
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Price,AttachId,Status")] Transaction transaction)
        {
            if (ModelState.IsValid)
            {
